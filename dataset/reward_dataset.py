...
from dataset.utils import exist_and_not_none, zero_pad_sequences
...
class RewardDataset(Dataset):
    ...
    def __init__(
        ...
        self.prompt_key = getattr(self.args, "prompt_key", None)
        self.chosen_key = getattr(self.args, "chosen_key", None)
        self.rejected_key = getattr(self.args, "rejected_key", None)
        self.apply_chat_template = getattr(self.args, "apply_chat_template", False)
